...
export const BulkAddParticipantsDialog: React.FC<BulkAddParticipantsDialogProps> = ({
  open,
  onClose,
  trialPlanId,
  cultureId,
      ...
      <DialogContent>
        <Box mb={3}>
          <Typography variant="body2" color="text.secondary">
            Культура: <strong>{cultureName}</strong> → Тип испытания: <strong>{trialTypeName}</strong>
          </Typography>
                  ...
                  <Grid item xs={12} sm={6}>
                    <FormControl fullWidth size="small">
                      ...
                      >
                        ...
                        <MenuItem value="not_provided">Не предоставлено</MenuItem>
                      </Select>
                    </FormControl>
                  </Grid>
                </Grid>
